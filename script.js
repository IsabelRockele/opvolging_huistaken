...
function toonRefterHerinneringOpStart(rol, klasDocs) {
  ...
  blok.href = 'schoolbeheer.html?v=20260909-7&open=refter';
  blok.target = '_blank';
  blok.rel = 'noopener';
...
function pasKnoppenToe(huistakenKnop, overgangKnop, schoolbeheerKnop, bestellingenKnop, oudercontactKnop, schoolKnop, groeigroepenKnop, zorgoverlegKnop, huiswerkklasKnop, klasafsprakenKnop, isSchoolBreed, isSecretariaat, heeftKlasbeheer, rolNaam = '') {
  ...
  if (schoolbeheerKnop) {
    ...
    if (isSecretariaat) {
      vulTegel(schoolbeheerKnop, 'schoolbeheer.html?v=20260909-7', '📋', 'Administratie & meldingen', 'Beheer klaslijsten, stuur meldingen, koppel leerkrachten en bereid het schooljaar voor.');
    } else if (isSchoolBreed) {
      vulTegel(schoolbeheerKnop, 'schoolbeheer.html?v=20260909-7', '🏫', 'Klaslijsten & opvolging', 'Bekijk per klas de lijsten, meldingen, refter, activiteiten en aankopen.');
    } else {
      vulTegel(schoolbeheerKnop, 'schoolbeheer.html?v=20260909-7', '🏫', 'Mijn klasorganisatie', 'Open je klaslijst, meldingen, refter, activiteiten en aankopen.');
    }
  }
