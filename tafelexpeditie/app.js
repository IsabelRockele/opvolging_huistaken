...
function renderCelebrationPreview(){
 ...
 map.innerHTML=`<div class="expedition-title">Onze zebraklas · ${esc(data.stage)}</div><div class="expedition-progress"><i style="width:${data.pct}%"></i></div><div class="expedition-caption">Voorbeeld van de gezamenlijke vooruitgang · ${data.pct}%</div>`
}
