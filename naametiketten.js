...
function scoodleCelXml(s){if(!s)return `<w:tc><w:tcPr><w:tcW w:w="3968" w:type="dxa"/></w:tcPr><w:p/></w:tc>`;const boven=`<w:tbl><w:tblPr><w:tblW w:w="3450" w:type="dxa"/><w:tblLayout w:type="fixed"/><w:tblBorders><w:top w:val="none"/><w:left w:val="none"/><w:bottom w:val="none"/><w:right w:val="none"/><w:insideH w:val="none"/><w:insideV w:val="none"/></w:tblBorders><w:tblCellMar><w:top w:w="0" w:type="dxa"/><w:left w:w="0" w:type="dxa"/><w:bottom w:w="0" w:type="dxa"/><w:right w:w="0" w:type="dxa"/></w:tblCellMar></w:tblPr><w:tblGrid><w:gridCol w:w="700"/><w:gridCol w:w="2750"/></w:tblGrid><w:tr><w:trPr><w:cantSplit/><w:trHeight w:hRule="exact" w:val="725"/></w:trPr><w:tc><w:tcPr><w:tcW w:w="700" w:type="dxa"/><w:vAlign w:val="center"/></w:tcPr><w:p><w:pPr><w:spacing w:before="0" w:after="0"/></w:pPr>${scoodleAfbeeldingXml()}</w:p></w:tc><w:tc><w:tcPr><w:tcW w:w="2750" w:type="dxa"/><w:vAlign w:val="center"/></w:tcPr><w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="190" w:lineRule="exact"/></w:pPr>${scoodleRun('www.scoodleplay.be',{vet:true,grootte:16})}<w:r><w:br/></w:r>${scoodleRun(s.naam,{vet:true,grootte:16})}</w:p></w:tc></w:tr></w:tbl>`;return `<w:tc><w:tcPr><w:tcW w:w="3968" w:type="dxa"/><w:tcMar><w:top w:w="55" w:type="dxa"/><w:left w:w="258" w:type="dxa"/><w:bottom w:w="45" w:type="dxa"/><w:right w:w="258" w:type="dxa"/></w:tcMar><w:vAlign w:val="center"/></w:tcPr>${boven}<w:p><w:pPr><w:spacing w:before="15" w:after="0" w:line="170" w:lineRule="exact"/><w:jc w:val="left"/></w:pPr>${scoodleRun('Je schoolcode: '+s.schoolcode)}<w:r><w:br/></w:r>${scoodleRun('Je klas: '+s.klas)}<w:r><w:br/></w:r>${scoodleRun('Je klasnummer: '+s.klasnummer)}<w:r><w:br/></w:r>${scoodleRun('Je wachtwoord: '+s.wachtwoord)}</w:p></w:tc>`}
