...
function scoodleRun(tekst,{vet=false,grootte=15}={}){return `<w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial"/>${vet?'<w:b/>':''}<w:sz w:val="${grootte}"/><w:szCs w:val="${grootte}"/></w:rPr><w:t xml:space="preserve">${xml(tekst)}</w:t></w:r>`}
function scoodleCelXml(s){if(!s)return `<w:tc><w:tcPr><w:tcW w:w="3968" w:type="dxa"/></w:tcPr><w:p/></w:tc>`;const regels=`${scoodleRun('www.scoodleplay.be',{vet:true,grootte:16})}<w:r><w:br/></w:r>${scoodleRun(s.naam,{vet:true,grootte:16})}<w:r><w:br/></w:r>${scoodleRun('Je schoolcode: '+s.schoolcode)}<w:r><w:br/></w:r>${scoodleRun('Je klas: '+s.klas)}<w:r><w:br/></w:r>${scoodleRun('Je klasnummer: '+s.klasnummer)}<w:r><w:br/></w:r>${scoodleRun('Je wachtwoord: '+s.wachtwoord)}`;const boven=`<w:tbl><w:tblPr><w:tblW w:w="3288" w:type="dxa"/><w:tblInd w:w="340" w:type="dxa"/><w:tblLayout w:type="fixed"/><w:tblBorders><w:top w:val="none"/><w:left w:val="none"/><w:bottom w:val="none"/><w:right w:val="none"/><w:insideH w:val="none"/><w:insideV w:val="none"/></w:tblBorders><w:tblCellMar><w:top w:w="0" w:type="dxa"/><w:left w:w="0" w:type="dxa"/><w:bottom w:w="0" w:type="dxa"/><w:right w:w="0" w:type="dxa"/></w:tblCellMar></w:tblPr><w:tblGrid><w:gridCol w:w="650"/><w:gridCol w:w="2638"/></w:tblGrid><w:tr><w:trPr><w:cantSplit/><w:trHeight w:hRule="exact" w:val="1320"/></w:trPr><w:tc><w:tcPr><w:tcW w:w="650" w:type="dxa"/><w:vAlign w:val="top"/></w:tcPr><w:p><w:pPr><w:spacing w:before="0" w:after="0"/></w:pPr>${scoodleAfbeeldingXml()}</w:p></w:tc><w:tc><w:tcPr><w:tcW w:w="2638" w:type="dxa"/><w:vAlign w:val="top"/></w:tcPr><w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="170" w:lineRule="exact"/></w:pPr>${regels}</w:p></w:tc></w:tr></w:tbl>`;return `<w:tc><w:tcPr><w:tcW w:w="3968" w:type="dxa"/><w:tcMar><w:top w:w="55" w:type="dxa"/><w:left w:w="0" w:type="dxa"/><w:bottom w:w="45" w:type="dxa"/><w:right w:w="0" w:type="dxa"/></w:tcMar><w:vAlign w:val="center"/></w:tcPr>${boven}<w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="1" w:lineRule="exact"/></w:pPr></w:p></w:tc>`}
...
function documentXml(paginas){scoodleAfbeeldingTeller=0;const inhoud=paginas.map((p,i)=>tabelXml(p)+(i<paginas.length-1?kleinAlinea('<w:br w:type="page"/>'):'')).join('');return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture"><w:body>${inhoud}${kleinAlinea()}<w:sectPr><w:type w:val="continuous"/><w:pgSz w:w="11906" w:h="16838"/><w:pgMar w:top="0" w:right="0" w:bottom="0" w:left="0" w:header="708" w:footer="708" w:gutter="0"/><w:cols w:space="708"/></w:sectPr></w:body></w:document>`}
