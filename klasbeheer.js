...
async function klasbeheerVeiligheidskopie(ref, reden) {
...
async function setDoc(ref, payload, options) {
  await klasbeheerVeiligheidskopie(ref, 'Klasbeheer vóór opslag');
  return firestoreSetDoc(ref, payload, options);
}
async function updateDoc(ref, payload) {
  await klasbeheerVeiligheidskopie(ref, 'Klasbeheer vóór wijziging');
